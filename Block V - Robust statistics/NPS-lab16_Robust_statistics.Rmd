...
table presented in slide 18 of the *Introduction and explicit robust estimators* section.
...
We have already seen how to hard-code the iterative algorithm described in
slide 13, but with an additional (robust) scale estimate $\hat{\sigma}$.
...
The `fit_MCD` object contains the raw and reweighted estimates
of location and scatter, the resulting robust Mahalanobis distances and
the best subset used for computing the raw estimates.
