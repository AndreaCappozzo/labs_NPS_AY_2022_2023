...
with depths in a multivariate setting. We will hereafter use `DepthProc`, which is a good general purpose
...
multivariate normal with mean vector `mu_good` and covariance matrix `sigma_common` and the other 5% from another
