...
have structured this tutorial as a very basic primer to understand how
to do some methodological and applied work in the framework of
...
$$ where $m(t)$ is the center and $\varepsilon(t)$ is a centered
...
Or even better we exploit the potential of the `roahd` package by
constructing a functional object:
...
call to be printed on the console (and in the knitted html file). If I do not use it I obtain the
following:
...
We appreciate how the shape outliers are for the entirely missed by the
